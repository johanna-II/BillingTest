...
class OpenAPIHandler:
    ...
    def find_operation(self, method: str, path: str) -> Optional[Dict[str, Any]]:
    ...
    def generate_response(self, operation: Dict[str, Any], status_code: int = 200) -> Dict[str, Any]:
    ...
    def _generate_number(self, schema: Dict[str, Any]) -> Union[int, float]:
    ...
    def validate_request(self, method: str, path: str, body: Optional[Dict] = None, 
                        query_params: Optional[Dict] = None) -> Optional[str]:
...
# Global instance
_openapi_handler: Optional[OpenAPIHandler] = None
...
def get_openapi_handler() -> Optional[OpenAPIHandler]:
