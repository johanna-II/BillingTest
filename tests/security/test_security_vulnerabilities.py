    ...
    def test_path_traversal_prevention(self, api_client, test_uuid):
        ...
        for payload in traversal_attempts:
            ...
            try:
                ...
                assert e.status_code in [400, 404], f"Path traversal not properly blocked: {payload}"
        ...
        for endpoint, method in endpoints:
            try:
                ...
                for pattern in sensitive_patterns:
                    assert pattern not in response_str, f"Potential sensitive data exposure: {pattern}"
            except APIRequestException:
    ...
    def test_input_validation_boundaries(self, api_client, test_uuid):
        ...
        for test_data in boundary_tests:
            ...
            try:
                ...
                assert 400 <= e.status_code < 500, f"Invalid input caused server error: {test_data}"
