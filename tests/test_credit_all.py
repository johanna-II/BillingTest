...
class TestCreditAll:
    ...
    def test_creditTC2(self):
        ...
        assert (statements_with_credit == total_payments == 0) & (
            rest_credit == total_credit_amt == expected_rest_credit
        )
    ...
    def test_creditTC4(self):
        ...
        self.calcObj.recalculationAll()
        self.credit.givePaidCredit(
            campaignId="<creditCode>", creditAmount=100000
        )  # 유료, 이벤트 크레딧
        # 결제 후 금액 비교
        statements, total_payments = self.config.commonTest()
        statements_with_credit = statements["totalAmount"] - 100000
    ...
    def test_creditTC5(self):
        ...
        self.calcObj.recalculationAll()
        self.credit.givePaidCredit(
            campaignId="<creditCode>", creditAmount=2000000
        )  # 유료, 전체형 크레딧
        # 결제 후 금액 비교
        statements, total_payments = self.config.commonTest()
        expected_rest_credit = 2000000 - statements["totalAmount"]
    ...
    def test_creditTC6(self):
        ...
        rest_credit, total_credit_amt = self.credit.inquiryRestCredit()
        assert (statements_with_credit == total_payments == expect_result) & (
            rest_credit == total_credit_amt == 2000000
        )
    ...
    def test_creditTC9(self):
        ...
        self.credit.givePaidCredit(
            campaignId="<creditCode>", creditAmount=1000000
        )  # 유료, 이벤트 크레딧
        ...
        assert (statements["totalAmount"] == total_payments == expect_result) & (
            rest_credit == total_credit_amt == 2000000
        )
