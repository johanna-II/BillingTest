...
class TestOpenAPIIntegration:
    ...
    def test_validate_valid_request(self) -> None:
        ...
        response = requests.post(
            f"{self.base_url}/openapi/validate", json=validation_request
        )
    ...
    def test_credit_creation_matches_spec(self) -> None:
        ...
        response = requests.post(f"{self.api_base}/credits", json=credit_data)
    ...
    def test_metering_query_parameters(self) -> None:
        ...
        response = requests.get(f"{self.api_base}/metering", params=params)
    ...
    def test_payment_update_patch(self) -> None:
        ...
        response = requests.patch(
            f"{self.api_base}/payments/PAY001", json=payment_update
        )
    ...
    def test_batch_job_creation(self) -> None:
        ...
        batch_request = {
            ...
            "parameters": {"month": "2025-01", "customer_ids": ["CUST001", "CUST002"]},
        }

        response = requests.post(f"{self.api_base}/batch/jobs", json=batch_request)
    ...
    def test_schema_validation_types(self) -> None:
        ...
        test_cases = [
            ...
            },
            {
                ...
                "endpoint": "/credits",
                "method": "POST",
                "body": {"customer_id": "CUST001", "amount": 100.0, "currency": "USD"},
                "expect_error": False,
            },
        ]
        ...
        for test_case in test_cases:
            ...
            if test_case["expect_error"]:
                ...
                ), f"Test case '{test_case['name']}' should fail"
                assert not response.json()["valid"]
            else:
                assert (
                    response.status_code == 200
                ), f"Test case '{test_case['name']}' should pass"
...
class TestOpenAPICompliance:
    ...
    def validate_against_schema(
        self, response_data: dict[str, Any], schema_path: str
    ) -> bool:
                ...
                if method in path_item:
                    ...
                    if method == "get":
                        ...
                        if "credits" in test_path:
                            ...
                            body = {"job_type": "BILLING_CALCULATION", "parameters": {}}
                        response = requests.post(
                            f"{self.base_url}{test_path}", json=body
                        )
                    elif method == "patch":
