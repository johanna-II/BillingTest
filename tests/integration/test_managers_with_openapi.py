...
from libs.constants import AdjustmentType, AdjustmentTarget, BatchJobCode, CounterType
...
class TestContractBasedTesting:
    ...
    def openapi_validator(self):
        ...
        with open("docs/openapi/billing-api.yaml", "r") as f:
