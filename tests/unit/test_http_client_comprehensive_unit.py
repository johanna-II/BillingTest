...
from libs.http_client import APIResponse, BillingAPIClient, HTTPMethod, RetryConfig
...
class TestBillingAPIClientComprehensiveUnit:
    ...
    def test_init_with_empty_base_url(self) -> None:
    ...
    def test_build_url_with_base_path(self) -> None:
    ...
    def test_request_with_json_data(self, mock_session_class) -> None:
        ...
        result = client.request(
            method=HTTPMethod.POST, endpoint="test", json_data=json_data
        )
    ...
    @patch("requests.Session")
    def test_request_with_custom_headers(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_handle_404_error(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_handle_500_error(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_connection_timeout(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_connection_error(self, mock_session_class) -> None:
    ...
    @patch("requests.Session")
    def test_retry_on_transient_error(self, mock_session_class) -> None:
    ...
    def test_wait_for_completion_immediate_success(self) -> None:
    ...
    def test_wait_for_completion_with_delay(self) -> None:
    ...
    @patch("requests.Session")
    def test_response_with_non_json_content(self, mock_session_class) -> None:
    ...
    def test_api_response_dataclass(self) -> None:
        ...
        error_response = APIResponse(
            data={"error": "not found"}, status_code=404, headers={}, elapsed_ms=50.0
        )
