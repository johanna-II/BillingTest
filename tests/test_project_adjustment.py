...
class TestProjectAdjustment(BaseAdjustmentTest):
    ...
    def setup_metering_data(self, init_config) -> None:
        """Set up metering data for all tests in the class."""
        # Clean existing data
        init_config.clean_data()

        # Send metering data
        self.send_metering_data(init_config, self.METERING_DATA)

    def test_fixed_discount_adjustment(self, init_config) -> None:
        ...
        # Perform calculation
        self.perform_calculation(init_config)

        # Get results
        statements, total_payments = init_config.common_test()
        ...
        # Verify results
        init_config.verify_assert(
            statements=statements["totalAmount"],
            payments=total_payments,
            expected_result=expected_total,
        )

    def test_percentage_discount_adjustment(self, init_config) -> None:
    ...
    def test_fixed_surcharge_adjustment(self, init_config) -> None:
    ...
    def test_combined_fixed_adjustments(self, init_config) -> None:
    ...
    def test_combined_percentage_and_fixed_adjustments(self, init_config) -> None:
